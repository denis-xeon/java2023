...
//        carList.add(car3);
        ...
        CarCollection<Car> carCollection1 = new CarCollection<Car> (  );
        System.out.println (carCollection1.isEmpty () );
        carCollection1.reinitialize ( taxiPark.getCars () );

        CarCollection<Car> carCollection2 = new CarCollection<Car> ( car1 );

        CarCollection<Car> carCollection3 = new CarCollection<Car> ( taxiPark.getCars () );
